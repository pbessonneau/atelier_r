...
%\institute{DEPP}
\date{06/2015}
\subtitle{Importation et sauvegarde de fichiers}
...
\begin{frame}[containsverbatim]
  \frametitle{La spécification des chemins sous R}
...
\begin{frame}[containsverbatim]
  \frametitle{Le répertoire de travail de R}
...
\begin{frame}[containsverbatim]
  \frametitle{Les commandes utiles pour les répertoires}
...
\begin{frame}[containsverbatim]
	\frametitle{Sauvegarde de l'environnement}
...
\begin{frame}[containsverbatim]
	\frametitle{Sauvegarde d'objets}
...
\begin{frame}[containsverbatim]
  	\frametitle{Restauration d'objets}
...
\begin{frame}[containsverbatim]
  	\frametitle{les options de \emph{read.table}}
...
\begin{frame}[containsverbatim]
  	\frametitle{l'aternative \emph{readr}}
...
\begin{frame}[containsverbatim]
  	\frametitle{l'aternative \emph{data.table}}
...
\begin{frame}[containsverbatim]
  	\frametitle{Exporter avec \emph{write.table}}
...
\begin{frame}[containsverbatim]
  	\frametitle{les options de \emph{write.table}}
...
\begin{frame}[containsverbatim]
  	\frametitle{Chargement de données au format fixe}
...
\begin{frame}[containsverbatim]
  	\frametitle{Chargement de données texte avec les fonctions de bas niveau}
...
\begin{frame}[containsverbatim]
  	\frametitle{Chargement de données texte/binaire avec les fonctions de bas niveau}
...
\begin{frame}[containsverbatim]
  	\frametitle{Sauvegarde de données texte avec les fonctions de bas niveau}
...
\begin{frame}[containsverbatim]
  	\frametitle{Sauvegarde de données texte/binaire avec les fonctions de bas niveau}
...
\begin{frame}[containsverbatim]
  	\frametitle{le paquet \emph{foreign}}
...
\begin{frame}[containsverbatim]
  	\frametitle{SPSS avec \emph{foreign}}
...
\begin{frame}[containsverbatim]
  	\frametitle{SAS avec \emph{foreign}}
...
\begin{frame}[containsverbatim]
  	\frametitle{SAS avec \emph{haven}}
...
\begin{frame}[containsverbatim]
  	\frametitle{Les possibilités de R avec les bases de données}
...
\begin{frame}[containsverbatim]
  	\frametitle{Le fonctionnement de la DBI}
...
\begin{frame}[containsverbatim]
  	\frametitle{Un exemple avec SQLite}
...
\begin{frame}[containsverbatim]
  	\frametitle{Connexion à la base de données}
...
\begin{frame}[containsverbatim]
  	\frametitle{Requêtes sur une table}
...
\begin{frame}[containsverbatim]
  	\frametitle{Requête SELECT sur une table}
...
\begin{frame}[containsverbatim]
  	\frametitle{Bonnes pratiques avec les serveurs...}
...
\begin{frame}[containsverbatim]
  	\frametitle{Rapatrier une table...}
...
\begin{frame}[containsverbatim]
  	\frametitle{Les commandes non standardisées}
...
\begin{frame}[containsverbatim]
    \frametitle{Le paquet \emph{XLConnect}}
...
\begin{frame}[containsverbatim]
    \frametitle{Lecture de fichier Excel}
...
\begin{frame}[containsverbatim]
    \frametitle{Sauvegarde dans un fichier Excel}
...
\begin{frame}[containsverbatim]
    \frametitle{Les arguments supplémentaires}
...
\begin{frame}[containsverbatim]
    \frametitle{\emph{readxl}, l'alternative à XLConnect}
...
\begin{frame}[containsverbatim]
    \frametitle{Les sorties pour le reporting}
