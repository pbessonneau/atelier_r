...
plot_map <- function() {
  ...
  # dpts <- readOGR(
  #   dsn="Cartes IGN/France/GEOFLA/1_couleurs_LIVRAISON_2015/GEOFLA_2-1_SHP_LAMB93_FR-ED152/DEPARTEMENT", 
  #   layer="DEPARTEMENT"
  # )
  # test <- match(dpts$CODE_DEPT,fusion$DEP)
  # 
  # par(mar=c(0,0,0,0))
  # plot(dpts,col=couleurs$couleur[test],xlim=c(627826,679415),ylim=c(6836932,6884222))
  # 
}
```
